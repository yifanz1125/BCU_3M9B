...
% V_net(10:9+nbus-ngen)|omega(16)|y(17)|omega(18)
function dfdt = F_3M9B_SP_DAE_VFM(x,system)
...
ydc = x(17);
omega3 = x(18);
omega_coi = [omega1 0 omega3]*m/mT;
...
dfdt(2) = kpp*(Pm(2)-Pe(2))+kip*ydc+omegab-omega_coi;%deltac2
dfdt(3) = omega3 - omega_coi;% deltac3

%omega
dfdt(16) = (Pm(1)-Pe(1)-d(1)*(omega1-omegab))/m(1);% omega1
dfdt(17) = 2/C_dc*(Pm(2)-Pe(2));% ydc
