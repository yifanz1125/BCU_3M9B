function Fun_ResultSaved(Datapath,Datatitle,casename)
    folder_matpower='E:\OneDrive - zju.edu.cn\A_FilesCloud\A1_System\B1_Simulations\C1_Matpower\matpower7.1';
    folder_matpower2='E:\OneDrive - zju.edu.cn\A_FilesCloud\A1_System\B1_Simulations\C1_Matpower\matpower7.1\lib';
    folder_matpower3='E:\OneDrive - zju.edu.cn\A_FilesCloud\A1_System\B1_Simulations\C1_Matpower\matpower7.1\data';
    ...
    if(results.success)
        ...
        fprinf('powerflow fault!');
    end
            
    folder_datasave='E:\OneDrive - zju.edu.cn\A_FilesCloud\A1_System\B1_Simulations\B2_3M9B\Data\';
    filename=['pf_' Datatitle,'.mat'];
    save([folder_datasave, filename],'pfdata');
